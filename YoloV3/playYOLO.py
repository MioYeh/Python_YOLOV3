...
#classesFile = "/data/home/mio/3_pelvis/cfg.org_pelvis/obj.names";
#modelConfiguration = "/data/home/mio/3_pelvis/cfg.org_pelvis/yolov3.cfg";
#modelWeights = "/data/home/mio/3_pelvis/cfg.org_pelvis/weights/yolov3.backup";
...
#path = '/data/home/mio/Femur/image_yolo/'

path = '/data/home/mio/yeh_image/Test/' 
...
if (args.image):
    ...
    outputFile = path+args.image[:-4]+'_yolo.jpg'
    #cap = cv2.VideoCapture('/data/home/mio/Femur/Images/0.jpg')
    #outputFile = path+args.image[:-4]+'_yolo.jpg'
